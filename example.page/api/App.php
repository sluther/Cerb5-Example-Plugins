 ...
 */
class ExPage extends CerberusPageExtension {
	private $_TPL_PATH = '';
	...
	function render() {
		...
		$tpl->display('devblocks:example.page::index.tpl');
	}
...
class ExPageTabOne extends Extension_ExampleTab {
...
class ExPageTabTwo extends Extension_ExampleTab {
